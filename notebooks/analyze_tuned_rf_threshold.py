...
print("=" * 75)
print("DAY 4 — TUNED RANDOM FOREST THRESHOLD ANALYSIS")
print("=" * 75)
...
# ============================================================
# 2. CREATE TUNED RANDOM FOREST
# ============================================================

print("\nCreating tuned Random Forest...")
...
print("\n" + "=" * 75)
print("TUNED RANDOM FOREST THRESHOLD ANALYSIS COMPLETE")
print("=" * 75)
